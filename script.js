document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('.overlay-container').addEventListener('click', function () {
        ...
        document.body.style.backgroundImage = 'url("/Users/rubenlauff/Downloads/countdown/nnn_countdown/background.jpeg")';
        ...
        let audio = new Audio('/Users/rubenlauff/Downloads/countdown/nnn_countdown/sound.mp3');
        audio.loop = true
        audio.play();
    });
