document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('.overlay-container').addEventListener('click', function () {
        ...
        document.body.style.backgroundImage = url("https://github.com/DaCUtePotato/NNN_TIMER/blob/main/background.jpeg");
        ...
        let audio = new Audio('https://github.com/DaCUtePotato/NNN_TIMER/blob/main/sound.mp3');
        audio.loop = true
        audio.play();
    });
